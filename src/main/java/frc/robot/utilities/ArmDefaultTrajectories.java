...
public class ArmDefaultTrajectories {
  ...
  public ArmDefaultTrajectories(Arm arm) {
    ...
    trajectories.put("HOME_DOUBLESUB", new ArmTrajectory(simpleProfile(.18, 0.16, 0.65, 0.89)));
    ...
    trajectories.put("L3_NEUTRAL", new ArmTrajectory(simpleProfile(1.16, 1.24, .49, .49)));
    ...
    trajectories.put("NEUTRAL_DOUBLESUB", new ArmTrajectory(simpleProfile(.49, .49, .65, 0.89)));
    trajectories.put("DOUBLESUB_NEUTRAL", new ArmTrajectory(simpleProfile(.89, .9, .49, .49)));
  }
